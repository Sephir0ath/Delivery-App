# Generated by Django 5.2 on 2025-06-02 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('cliente', 'Cliente'), ('conductor', 'Conductor'), ('admin', 'Administrador'), ('despachador', 'Despachador')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destinatario', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app_envios.cliente')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('asignador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_envios.despachador')),
                ('conductor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_envios.conductor')),
